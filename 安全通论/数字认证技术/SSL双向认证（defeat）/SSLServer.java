...
public class SSLServer {  
    ...
    private static final String SERVER_KEY_STORE_PASSWORD       = "w1z2c3";  
    private static final String SERVER_TRUST_KEY_STORE_PASSWORD = "w1z2c3";  
    ...
    public void init() {  
        try {  
            ...
            ks.load(new FileInputStream("D:\\20201216\\kserver.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());  
            tks.load(new FileInputStream("D:\\20201216\\tserver.keystore"), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());  
