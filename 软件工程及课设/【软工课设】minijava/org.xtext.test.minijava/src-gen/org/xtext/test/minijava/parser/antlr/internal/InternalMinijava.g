...
entryRulePackageDecl returns [String current=null]:
	{ newCompositeNode(grammarAccess.getPackageDeclRule()); }
	iv_rulePackageDecl=rulePackageDecl
	{ $current=$iv_rulePackageDecl.current.getText(); }
	EOF;

// Rule PackageDecl
rulePackageDecl returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleQualifiedName_ returns [String current=null]:
	{ newCompositeNode(grammarAccess.getQualifiedName_Rule()); }
	iv_ruleQualifiedName_=ruleQualifiedName_
	{ $current=$iv_ruleQualifiedName_.current.getText(); }
	EOF;

// Rule QualifiedName_
ruleQualifiedName_ returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleQualifiedNameLi returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getQualifiedNameLiRule()); }
	iv_ruleQualifiedNameLi=ruleQualifiedNameLi
	{ $current=$iv_ruleQualifiedNameLi.current; }
	EOF;

// Rule QualifiedNameLi
ruleQualifiedNameLi returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleVarLi returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getVarLiRule()); }
	iv_ruleVarLi=ruleVarLi
	{ $current=$iv_ruleVarLi.current; }
	EOF;

// Rule VarLi
ruleVarLi returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		(
			...
			(
				(
					lv_isArrayElementAssignment_20_0='['
					{
